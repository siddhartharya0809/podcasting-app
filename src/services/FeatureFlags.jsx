...
export class FeatureFlags {
  static enableTranscription =
    process.env && process.env.REACT_APP_ENABLE_TRANSCRIPTION === "true";
  ...
  static init() {
    ...
    // extra config to hls to bring down the latency
    window.HMS.OPTIMISE_HLS_LATENCY = false;

    // ask permission in preview even if role dosen't have it
    window.HMS.ALWAYS_REQUEST_PERMISSION = false;
